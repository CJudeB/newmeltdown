...
class Event {
    ...
    public static void currentEvent(Player player, boolean hasVisited) {
        ...
        if (!hasVisited) {
            ...
            alternateTiles.put("0", "alt 1a");
            alternateTiles.put("1", "alt 1c");
            alternateTiles.put("2", "alt 1c");
            alternateTiles.put("3", "alt 1d");
            alternateTiles.put("4", "alt 1e");
            alternateTiles.put("5", "alt 2a");
            alternateTiles.put("6", "alt 2b");
            alternateTiles.put("7", "alt 2c");
            alternateTiles.put("8", "alt 2d");
            alternateTiles.put("9", "alt 2e");
            alternateTiles.put("10", "alt 3a");
            alternateTiles.put("11", "alt 3b");
            alternateTiles.put("12", "alt 3c");
            alternateTiles.put("13", "alt 3d");
            alternateTiles.put("14", "alt 3e");
            alternateTiles.put("15", "alt 4a");
            alternateTiles.put("16", "alt 4b");
            alternateTiles.put("17", "alt 4c");
            alternateTiles.put("18", "alt 4d");
            alternateTiles.put("19", "alt 4e");
            alternateTiles.put("20", "alt 5a");
            alternateTiles.put("21", "alt 5b");
            alternateTiles.put("22", "alt 5c");
            alternateTiles.put("23", "alt 5d");
            alternateTiles.put("24", "alt 5e");
